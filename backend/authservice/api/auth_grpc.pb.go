...
type AuthServiceClient interface {
	RegisterUser(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*User, error)
	AuthUser(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*User, error)
}
...
func (c *authServiceClient) RegisterUser(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*User, error) {
...
func (c *authServiceClient) AuthUser(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
type AuthServiceServer interface {
	RegisterUser(context.Context, *LoginRequest) (*User, error)
	AuthUser(context.Context, *LoginRequest) (*User, error)
...
func (UnimplementedAuthServiceServer) RegisterUser(context.Context, *LoginRequest) (*User, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterUser not implemented")
}
func (UnimplementedAuthServiceServer) AuthUser(context.Context, *LoginRequest) (*User, error) {
